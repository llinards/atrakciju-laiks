...
<div>
    ...
    <section class="px-4 pb-16 pt-14 lg:px-8">
        <div class="mx-auto flex max-w-7xl flex-col gap-14">
            <x-public.section-heading subtitle="Izvēlies sev piemērotāko kategoriju bērnu ballītēm, pasākumiem un svinībām.">
                Ko vēlies nomāt šodien?
            </x-public.section-heading>

            <div class="flex flex-wrap justify-center gap-10">
                <x-public.category-card
                    color="splash"
                    title="Piepūšamās atrakcijas"
                    description="Jautrībai, kustībai un bērnu priekam"
                    href="#"
                    :image="asset('images/category-atrakcijas.png')"
                    image-alt="Piepūšamā atrakcija"
                />
                <x-public.category-card
                    color="brand"
                    title="Teltis"
                    description="Ērtam pasākumam jebkuros laikapstākļos"
                    href="#"
                    :image="asset('images/category-teltis.png')"
                    image-alt="Pasākumu telts"
                />
                <x-public.category-card
                    color="sun"
                    title="Nojumes"
                    description="Praktisks risinājums svinībām un pasākumiem ārā"
                    href="#"
                    :image="asset('images/category-nojumes.png')"
                    image-alt="Nojume"
                />
            </div>
        </div>
    ...
    <section class="px-4 py-16 lg:px-8">
        <div class="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <img
                ...
                alt="Bērni spēlējas piepūšamajā atrakcijā"
            ...
            <div class="flex flex-col items-start gap-8">
                ...
                <p class="font-heading text-xl font-semibold leading-[30px] text-gray-800">
                    Svētku plānošana ir rūpīgi pārdomāts un īpašs process - kādam tie var būt pat dzīves lielākie svētki.
                ...
                <ul class="flex flex-col gap-2.5">
                    @foreach ([
                        ...
                        'Drošs un kvalitatīvs inventārs',
                        'Atrakcijas dažādiem pasākumiem',
                        'Ātra un ērta rezervācija',
                    ] as $benefit)
    ...
    <section class="px-4 py-16 lg:px-8">
        <div class="mx-auto flex max-w-7xl flex-col gap-14">
            <x-public.section-heading subtitle="Atbildes uz jautājumiem, kas visbiežāk rodas par mūsu pakalpojumiem, rezervāciju un piegādi.">
